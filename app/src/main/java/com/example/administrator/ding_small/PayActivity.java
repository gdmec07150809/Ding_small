...
public class PayActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.creat_pay);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.number_enter:
                ...
                break;
            case R.id.received:
                intent=new Intent(PayActivity.this,ReceivedActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                break;
            case R.id.payable:
                intent=new Intent(PayActivity.this,PayableActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                break;
            case R.id.notepad:
                intent=new Intent(PayActivity.this,NotepadActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                break;
            case R.id.receivables:
                intent=new Intent(PayActivity.this,ReceivablesActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                break;
            case R.id.remark:
                intent=new Intent(PayActivity.this,RemarksActivity.class);
             ...
             //   intent.putExtra("bg_number",bg_number);
                ...
                break;
            case R.id.day:
                TimeSelector timeSelector = new TimeSelector(PayActivity.this, new TimeSelector.ResultHandler() {
                    @Override
